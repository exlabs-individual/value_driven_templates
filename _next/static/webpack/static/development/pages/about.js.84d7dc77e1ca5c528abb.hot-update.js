...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:calc(100% - 40px);margin-right:0;align-items:center;border:1px solid red;& .special-link{display:block;height:30px;line-height:30px;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.84d7dc77e1ca5c528abb.hot-update.js.map