...
})(["background:linear-gradient(90deg,#044aaf,#022558);color:", ";padding:", ";display:flex;flex-direction:", ";justify-content:space-between;& > .about-container{font-size:", ";}& > .copyright{font-size:13px;margin-top:5px;}"], ({
  theme
}) => theme.color.white, props => props.isMobile ? '15px 20px' : '20px 60px', props => props.isMobile ? 'column' : 'row', props => props.isMobile ? '14px' : '19px');
...
})(["display:flex;align-items:center;& > .title{flex:1;font-weight:700;margin-right:5px;}& > .link{margin-left:5px;color:", ";text-decoration:none;display:flex;align-items:center;& > .logo-img{margin-right:5px;}}"], ({
  theme
}) => theme.color.white);
...
//# sourceMappingURL=_app.js.1a855a4553fcda1175f3.hot-update.js.map