...
})(["min-width:70px;min-height:70px;max-width:70px;max-height:70px;text-align:center;line-height:70px;color:", ";background-color:'#EBEBEB';border-radius:50%;margin:0 20px;position:relative;font-size:27px;", " @keyframes setColor{0%{background:#ebebeb;}100%{background:#044aaf;}}&::after{content:'';display:block;width:6px;height:", ";background-color:'#EBEBEB';position:absolute;top:70px;left:50%;transform:translateX(-50%);", "}"], ({
  theme
}) => theme.color.white, props => props.active && "\n  animation: setColor 1s 1 0s linear;\n  ", props => "".concat(props.containerHeight - 70, "px"), props => props.active && "\n  animation: setColor 1s 1 0s linear;\n  ");

/***/ })

})
//# sourceMappingURL=how-to-contribute.js.9e1915646cc08db1247d.hot-update.js.map