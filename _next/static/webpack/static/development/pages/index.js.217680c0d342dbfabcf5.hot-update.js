...
})(["display:flex;flex-direction:column;width:calc(50% - 50px);& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:100%;margin-right:0;align-items:center;& .special-link{display:block;height:25px;line-height:25px;font-size:14px;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=index.js.217680c0d342dbfabcf5.hot-update.js.map