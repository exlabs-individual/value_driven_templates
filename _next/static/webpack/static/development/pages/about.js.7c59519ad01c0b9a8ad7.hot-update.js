...
})(["display:flex;justify-content:space-between;margin-top:20px;width:100%;border:1px solid red;@media (max-width:", "){flex-direction:column;margin-top:0px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:100%;margin-right:0;align-items:center;& .special-link{display:block;height:25px;line-height:25px;font-size:14px;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.7c59519ad01c0b9a8ad7.hot-update.js.map