...
const StyledSection = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].section.attrs(({
  textPostion = 'left'
}) => ({
  textPostion
})).withConfig({
...
})(["width:100%;display:flex;justify-content:space-between;min-height:100vh;flex-direction:", ";"], props => props.textPostion === 'left' ? 'row' : 'row-reverse');
...
})(["flex:1;display:flex;flex-direction:column;justify-content:center;color:", ";"], ({
  theme
}) => theme.color.black);
...
//# sourceMappingURL=how-to-contribute.js.1e90b0ac831c0504dd0b.hot-update.js.map