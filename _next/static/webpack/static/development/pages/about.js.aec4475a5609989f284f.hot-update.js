...
})(["display:flex;flex-direction:column;color:", ";min-height:calc(100vh - 142px);overflow-y:scroll;padding:", ";@media (max-width:", "){padding:", ";height:calc(100vh - 104px);border:1px solid red;}"], ({
  theme
}) => theme.color.black, ({
  theme
...
})(["max-width:40%;font-size:40px;@media (max-width:", "){font-size:30px;max-width:70%;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["display:flex;align-items:center;justify-content:space-between;width:100%;@media (max-width:", "){flex-direction:column;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["width:40%;@media (max-width:", "){width:100%;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["width:55%;margin-left:20px;font-size:27px;font-weight:300;@media (max-width:", "){width:100%;margin-left:0;font-size:19px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.aec4475a5609989f284f.hot-update.js.map