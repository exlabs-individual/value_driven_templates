...
})(["width:100%;height:calc(100vh - 62px);color:", ";padding:10px ", ";@media (max-width:", "){height:auto;margin-bottom:30px;}"], ({
  theme
}) => theme.color.black, ({
  theme
}) => theme.padding.small, ({
...
})(["display:flex;justify-content:space-between;margin-top:20px;@media (max-width:", "){flex-direction:column-reverse;}"], ({
  theme
...
//# sourceMappingURL=about.js.9fb1645828e7796bebf5.hot-update.js.map