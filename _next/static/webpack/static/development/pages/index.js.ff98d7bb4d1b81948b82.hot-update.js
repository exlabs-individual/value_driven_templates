...
})(["border:1px solid red;width:100%;display:flex;justify-content:space-between;align-items:center;@media (min-width:1200px){height:calc(100vh - 122px);}"]);
...
})(["padding-left:", ";width:40%;border:1px solid red;& > .title{font-size:49px;margin:0;font-family:", ";}& > .sub-title{margin:0;}& > .additional-info{display:block;margin:0;}& > .special-link{display:inline-block;}"], ({
  theme
}) => theme.padding.big, ({
  theme
...
//# sourceMappingURL=index.js.ff98d7bb4d1b81948b82.hot-update.js.map