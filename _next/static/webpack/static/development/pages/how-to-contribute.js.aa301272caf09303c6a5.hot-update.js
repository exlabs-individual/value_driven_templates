...
})(["font-size:49px;margin-bottom:20px;@media (max-width:", "){font-size:31px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
})(["font-size:21px;@media (max-width:", "){font-size:17px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=how-to-contribute.js.aa301272caf09303c6a5.hot-update.js.map