...
})(["padding-left:", ";width:40%;color:", ";& > .title{font-size:49px;margin:0;}& > .sub-title{margin:0;margin-top:5px;font-weight:500;font-size:21px;}& > .additional-info{display:block;margin:40px 0 50px;font-weight:300;&::before{content:'';display:inline-block;margin-right:10px;height:2px;width:30px;background-color:", ";margin-bottom:5px;}}& > .special-link{display:inline-block;}"], ({
  theme
}) => theme.padding.big, ({
  theme
}) => theme.color.black, ({
...
//# sourceMappingURL=index.js.368adc39a7ee78689773.hot-update.js.map