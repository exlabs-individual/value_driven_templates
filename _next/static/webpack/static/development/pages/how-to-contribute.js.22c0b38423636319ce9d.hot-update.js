...
const InformationSection = ({
  ...
  const handleScroll = react__WEBPACK_IMPORTED_MODULE_0___default.a.useCallback(() => {
    ...
    if (!isActive && window.pageYOffset > ((_containerRef$current2 = containerRef.current) === null || _containerRef$current2 === void 0 ? void 0 : _containerRef$current2.getBoundingClientRect().bottom)) {
      setActive(true);
    }
...
//# sourceMappingURL=how-to-contribute.js.22c0b38423636319ce9d.hot-update.js.map