...
})(["height:350px;background-position:center;background-size:cover;display:flex;flex-direction:column;justify-content:flex-end;box-shadow:inset 0px 370px 0px rgba(4,74,175,0.5);color:", ";padding:0 0 40px 60px;& > .category{}"], ({
  theme
}) => theme.color.white);
...
//# sourceMappingURL=[id].js.442d32f63d22f174e37e.hot-update.js.map