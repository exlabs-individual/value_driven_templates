...
})(["height:350px;background-position:center;background-size:cover;display:flex;flex-direction:column;justify-content:flex-end;box-shadow:inset 0px 390px 0px rgba(4,74,175,0.5);color:", ";padding:0 0 40px 60px;& > .category{font-size:", ";}& > .title{font-size:39px;font-weight:700;margin:20px 0;}"], ({
  theme
}) => theme.color.white, ({
  theme
...
//# sourceMappingURL=[id].js.4d2e790ee7e8f7c54b5f.hot-update.js.map