...
})(["width:70%;margin-right:20px;& .article-aside{position:sticky;top:82px;}color:", ";font-size:16px;& > h1{font-size:37px;}& > h2{font-size:31px;}& > h3{font-size:27px;}& > h4{font-size:23px;}& > h5{font-size:19px;}& > h5{font-size:17px;}& > p{padding:20px 0;}@media (max-width:", "){width:100%;margin-right:0;}"], ({
  theme
}) => theme.color.black, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=[id].js.cec9140ff9cf60c772cd.hot-update.js.map