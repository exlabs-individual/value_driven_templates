...
})(["width:70%;margin-right:20px;& .article-aside{position:sticky;top:82px;}color:", ";& > h1{font-size:37px;}@media (max-width:", "){width:100%;margin-right:0;}"], ({
  theme
}) => theme.color.black, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=[id].js.754df2cd917bdfbfc198.hot-update.js.map