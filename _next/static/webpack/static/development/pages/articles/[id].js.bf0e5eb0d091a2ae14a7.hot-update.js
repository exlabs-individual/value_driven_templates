...
})(["height:300px;background-position:center;background-size:cover;display:flex;flex-direction:column;justify-content:flex-end;box-shadow:inset 0px 340px 0px rgba(4,74,175,0.6);color:", ";padding:0 0 40px 60px;& > .category{font-size:", ";}& > .title{font-size:39px;margin:15px 0;}@media (max-width:", "){padding:0 20px 20px;height:250px;& > .category{font-size:", ";}& > .title{font-size:23px;margin:5px 0 20px;}}"], ({
  theme
}) => theme.color.white, ({
  theme
...
})(["display:flex;align-items:center;& .author__img{width:40px;height:40px;margin-right:10px;}& .author__name{font-size:", ";}& > .publish-date{margin-left:20px;font-size:", ";}@media (max-width:", "){& .author__img{width:30px;height:30px;margin-right:10px;}& .author__name{font-size:", ";}& > .publish-date{margin-left:20px;font-size:", ";}}"], ({
  theme
}) => theme.fontSize.medium, ({
  theme
}) => theme.fontSize.medium, ({
...
})(["background-color:", ";box-shadow:0px 3px 6px rgba(0,0,0,0.3);padding:20px 60px;"], ({
  theme
}) => theme.color.white);
...
//# sourceMappingURL=[id].js.bf0e5eb0d091a2ae14a7.hot-update.js.map