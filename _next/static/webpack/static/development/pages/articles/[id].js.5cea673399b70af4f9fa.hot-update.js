...
})(["background-color:", ";box-shadow:0px 3px 6px rgba(0,0,0,0.3);padding:20px 60px;display:flex;@media (max-width:", "){padding:20px;}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=[id].js.5cea673399b70af4f9fa.hot-update.js.map