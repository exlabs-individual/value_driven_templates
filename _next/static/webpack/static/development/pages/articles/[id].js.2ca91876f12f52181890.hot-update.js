...
})(["display:flex;align-items:center;& .author__img{width:40px;height:40px;margin-right:10px;}& .author__name{font-size:", ";}& > .publish-date{margin-left:20px;font-size:", ";}@media (max-width:", "){& .author__img{width:30px;height:30px;margin-right:5px;}& .author__name{font-size:", ";}& > .publish-date{margin-left:20px;font-size:", ";}}"], ({
  theme
}) => theme.fontSize.medium, ({
  theme
}) => theme.fontSize.medium, ({
...
//# sourceMappingURL=[id].js.2ca91876f12f52181890.hot-update.js.map