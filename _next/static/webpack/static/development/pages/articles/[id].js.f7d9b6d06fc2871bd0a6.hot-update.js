...
})(["height:350px;background-position:center;background-size:cover;display:flex;flex-direction:column;justify-content:flex-end;box-shadow:inset 0px 390px 0px rgba(4,74,175,0.5);color:", ";padding:0 0 40px 60px;& > .category{}"], ({
  theme
}) => theme.color.white);
...
//# sourceMappingURL=[id].js.f7d9b6d06fc2871bd0a6.hot-update.js.map