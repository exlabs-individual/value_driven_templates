...
})(["height:250px;background-position:center;background-size:cover;display:flex;flex-direction:column;justify-content:flex-end;box-shadow:inset 0px 390px 0px rgba(4,74,175,0.6);color:", ";padding:0 0 40px 60px;& > .category{font-size:", ";}& > .title{font-size:39px;font-weight:700;margin:15px 0;}"], ({
  theme
}) => theme.color.white, ({
  theme
...
//# sourceMappingURL=[id].js.4d20a74550a950b30733.hot-update.js.map