...
})(["height:300px;background-position:center;background-size:cover;display:flex;flex-direction:column;justify-content:flex-end;box-shadow:inset 0px 340px 0px rgba(4,74,175,0.6);color:", ";padding:0 0 40px 60px;& > .category{font-size:", ";}& > .title{font-size:39px;margin:15px 0;}@media (max-width:", "){padding:0 0 20px 20px;& > .category{font-size:", ";}& > .title{font-size:27px;margin:5px 0;}}"], ({
  theme
}) => theme.color.white, ({
  theme
...
//# sourceMappingURL=[id].js.7fcbdaf738940f7a9c06.hot-update.js.map