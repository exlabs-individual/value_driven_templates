...
})(["background-color:", ";box-shadow:0px 3px 6px rgba(0,0,0,0.3);padding:20px 60px;display:flex;flex-direction:column;@media (max-width:", "){padding:20px;}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=[id].js.d3be0df947a64ecc82c8.hot-update.js.map