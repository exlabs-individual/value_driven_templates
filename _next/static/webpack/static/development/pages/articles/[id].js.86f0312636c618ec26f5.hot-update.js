...
})(["background-color:", ";box-shadow:0px 3px 6px rgba(0,0,0,0.3);padding:20px 60px;@media (max-width:", "){padding:10px 40px;}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=[id].js.86f0312636c618ec26f5.hot-update.js.map