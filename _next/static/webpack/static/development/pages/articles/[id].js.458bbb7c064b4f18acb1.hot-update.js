...
})(["height:350px;background-position:center;background-size:cover;display:flex;flex-direction:column;justify-content:flex-end;box-shadow:inset 0px 390px 0px rgba(4,74,175,0.6);color:", ";padding:0 0 40px 60px;& > .category{font-size:", ";}& > .title{font-size:39px;font-weight:700;margin:15px 0;}"], ({
  theme
}) => theme.color.white, ({
  theme
...
})(["display:flex;align-items:center;& .author__img{width:40px;height:40px;margin-right:20px;}& .author__name{font-size:", ";}& > .publish-date{margin-left:20px;font-size:", ";}"], ({
  theme
}) => theme.fontSize.medium, ({
  theme
}) => theme.fontSize.medium);
...
//# sourceMappingURL=[id].js.458bbb7c064b4f18acb1.hot-update.js.map