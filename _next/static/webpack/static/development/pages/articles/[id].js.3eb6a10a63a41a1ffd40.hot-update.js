...
})(["background-color:", ";box-shadow:0px 3px 6px rgba(0,0,0,0.3);padding:20px 60px;@media (max-width:", "){padding:10px 20px;}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=[id].js.3eb6a10a63a41a1ffd40.hot-update.js.map