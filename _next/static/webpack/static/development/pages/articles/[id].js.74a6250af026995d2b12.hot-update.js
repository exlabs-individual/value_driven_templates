...
})(["background-color:", ";box-shadow:0px 3px 6px rgba(0,0,0,0.3);display:flex;@media (max-width:", "){padding:20px;}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=[id].js.74a6250af026995d2b12.hot-update.js.map