...
})(["border:1px solid red;width:100%;display:flex;justify-content:space-between;align-items:center;@media (min-width:1200px){height:calc(100vh - 112px);}"]);
...
})(["padding-left:", ";width:40%;border:1px solid red;& > .title{font-size:49px;margin:0;}& > .sub-title{margin:0;margin-top:5px;font-weight:500;}& > .additional-info{display:block;margin:60px 0 40px;}& > .special-link{display:inline-block;}"], ({
  theme
}) => theme.padding.big);
...
//# sourceMappingURL=index.js.8bc6a653feba2a3162bb.hot-update.js.map