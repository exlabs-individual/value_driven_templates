...
})(["min-width:100px;min-height:100px;max-width:100px;max-height:100px;text-align:center;line-height:100px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;position:relative;&::after{content:'';display:block;width:6px;height:", ";background-color:", ";position:absolute;top:50px;left:50%;transform:translateX(-50%);}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.color.primary, props => "".concat(props.containerHeight - 50, "px"), ({
  theme
}) => theme.color.primary);
...
//# sourceMappingURL=how-to-contribute.js.33f33931dec2eadfabc6.hot-update.js.map