...
})(["font-size:65px;margin-top:130px;@media (max-width:", "){font-size:40px;margin-top:10px;}@media (max-width:", "){font-size:28px;margin-top:10px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=how-to-contribute.js.beea8953462750b2f144.hot-update.js.map