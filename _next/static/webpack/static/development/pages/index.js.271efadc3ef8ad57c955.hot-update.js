...
})(["padding-left:", ";width:40%;color:", ";& > .title{font-size:49px;margin:0;}& > .sub-title{margin:0;margin-top:5px;font-weight:500;font-size:21px;}& > .additional-info{display:block;margin:40px 0 50px;&::before{content:'XDD';display:inline-block;}}& > .special-link{display:inline-block;}"], ({
  theme
}) => theme.padding.big, ({
  theme
}) => theme.color.black);
...
//# sourceMappingURL=index.js.271efadc3ef8ad57c955.hot-update.js.map