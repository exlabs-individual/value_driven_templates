...
})(["width:100%;height:calc(100vh - 62px);color:", ";padding:10px ", ";"], ({
  theme
}) => theme.color.black, ({
  theme
}) => theme.padding.small);
...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;box-shadow:0px 3px 6px rgba(0,0,0,0.3);}"]);
...
//# sourceMappingURL=about.js.f2c8b0e728b3a2e2a75c.hot-update.js.map