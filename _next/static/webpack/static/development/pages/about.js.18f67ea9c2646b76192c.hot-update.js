...
})(["width:55%;margin-left:20px;font-size:27px;font-weight:300;@media (max-width:", "){width:100%;margin-left:0;font-size:19px;border:1px solid red;}@media (max-width:", "){width:50%;font-size:19px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=about.js.18f67ea9c2646b76192c.hot-update.js.map