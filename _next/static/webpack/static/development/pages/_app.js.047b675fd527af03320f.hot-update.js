...
})(["background:linear-gradient(90deg,#044aaf,#022558);color:", ";padding:20px 60px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;& > .copyright{font-size:14px;margin-top:5px;}"], ({
  theme
}) => theme.color.white);
...
})(["display:flex;align-items:center;font-size:17px;& > .title{font-weight:700;margin-right:5px;}& > .link{margin-left:5px;color:", ";text-decoration:none;display:flex;align-items:center;& > .logo-img{margin-right:5px;}}"], ({
  theme
}) => theme.color.white);
...
//# sourceMappingURL=_app.js.047b675fd527af03320f.hot-update.js.map