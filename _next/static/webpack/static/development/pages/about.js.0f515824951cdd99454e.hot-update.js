...
})(["display:flex;flex-direction:column;width:50%;margin-right:50px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:100%;margin-right:0;align-items:center;& .special-link{display:block;height:25px;line-height:25px;font-size:14px;}}@media (max-width:", "){}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.0f515824951cdd99454e.hot-update.js.map