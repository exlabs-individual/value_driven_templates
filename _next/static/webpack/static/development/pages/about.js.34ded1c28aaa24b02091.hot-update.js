...
})(["width:100%;height:calc(100vh - 62px);color:", ";padding:10px ", ";@media (max-width:", "){height:auto;}@media (max-width:", "){height:calc(100vh - 62px);}"], ({
  theme
}) => theme.color.black, ({
  theme
}) => theme.padding.small, ({
...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:calc(100% - 40px);margin-right:0;align-items:center;justify-content:center;& .special-link{display:block;height:30px;line-height:30px;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["font-size:65px;margin-top:130px;@media (max-width:", "){font-size:27px;margin-top:30px;border:1px solid red;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["font-size:30px;font-weight:300;margin-bottom:70px;@media (max-width:", "){font-size:25px;max-width:90%;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["width:60%;@media (max-width:", "){width:50%;}@media (max-width:", "){width:80%;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.34ded1c28aaa24b02091.hot-update.js.map