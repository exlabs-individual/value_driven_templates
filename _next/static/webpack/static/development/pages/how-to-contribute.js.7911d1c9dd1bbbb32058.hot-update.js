...
})(["min-width:50px;min-height:50px;max-width:50px;max-height:50px;text-align:center;line-height:50px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;&::after{content:'';width:10px;height:100%;background-color:", ";}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.color.primary, ({
...
//# sourceMappingURL=how-to-contribute.js.7911d1c9dd1bbbb32058.hot-update.js.map