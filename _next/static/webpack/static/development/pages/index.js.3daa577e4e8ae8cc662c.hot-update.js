...
})(["display:flex;flex-direction:column;width:calc(48% - 50px);margin-right:50px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:100%;margin-right:0;align-items:center;& .special-link{display:block;height:25px;line-height:25px;font-size:14px;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=index.js.3daa577e4e8ae8cc662c.hot-update.js.map