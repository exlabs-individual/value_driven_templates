...
})(["display:flex;border:1px solid red;align-items:center;font-size:17px;& > .title{font-weight:700;margin-right:5px;}& > .link{margin-left:5px;color:", ";text-decoration:none;display:flex;align-items:center;& > .logo-img{margin-right:5px;}}"], ({
  theme
}) => theme.color.white);
...
//# sourceMappingURL=_app.js.1fbe3d7624f6d5528faa.hot-update.js.map