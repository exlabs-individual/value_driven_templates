...
})(["width:100%;height:calc(100vh - 62px);color:", ";padding:10px ", ";@media (max-width:", "){height:auto;margin-bottom:30px;}@media (max-width:", "){height:calc(100vh - 62px);border:1px solid red;}"], ({
  theme
}) => theme.color.black, ({
  theme
}) => theme.padding.small, ({
...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;}"]);
...
//# sourceMappingURL=about.js.0a60869bc4ca597da518.hot-update.js.map