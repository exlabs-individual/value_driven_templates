...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:100%;margin-right:0;align-items:center;& .special-link{display:block;height:30px;line-height:30px;font-size:14px;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.cc78be2cc01f51588db2.hot-update.js.map