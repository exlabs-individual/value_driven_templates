...
})(["display:flex;flex-direction:column;width:50%;margin-right:50px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:100%;margin-right:0;align-items:center;}@media (max-width:", "){& .special-link{display:block;height:25px;line-height:25px;font-size:14px;border:1px solid red;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["font-size:65px;margin-top:130px;@media (max-width:", "){font-size:28px;margin-top:30px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["font-size:30px;font-weight:300;margin:20px 0 70px;@media (max-width:", "){font-size:19px;text-align:center;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.d112e24a74295ca1fe40.hot-update.js.map