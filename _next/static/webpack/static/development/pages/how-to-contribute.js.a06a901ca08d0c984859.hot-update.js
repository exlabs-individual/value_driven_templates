...
})(["font-size:65px;margin-top:130px;@media (max-width:", "){font-size:50px;}@media (max-width:", "){font-size:28px;margin-top:10px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=how-to-contribute.js.a06a901ca08d0c984859.hot-update.js.map