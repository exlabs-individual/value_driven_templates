...
})(["display:flex;justify-content:center;align-items:center;& > a{padding:10px 20px;background-color:", ";color:", ";text-decoration:none;border-radius:4px;transition:background-color 0.2s ease;&:hover{}}"], ({
  theme
}) => theme.color.red, ({
  theme
}) => theme.color.white);
...
//# sourceMappingURL=_app.js.b10603717f3be18c4dbd.hot-update.js.map