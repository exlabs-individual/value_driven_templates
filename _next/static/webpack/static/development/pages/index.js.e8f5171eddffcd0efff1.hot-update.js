...
})(["border:1px solid red;width:100%;height:calc(100vh - 72px);display:flex;justify-content:space-between;align-items:center;"]);
...
})(["padding-left:", ";width:50%;border:1px solid red;& > .title{font-size:49px;margin:0;font-family:", ";}& > .sub-title{margin:0;}& > .additional-info{display:block;margin:0;}& > .special-link{display:inline-block;}"], ({
  theme
}) => theme.padding.big, ({
  theme
...
//# sourceMappingURL=index.js.e8f5171eddffcd0efff1.hot-update.js.map