...
})(["height:50%;@media (max-width:", "){width:50%;border:1px solid red;}@media (max-width:", "){min-width:80%;max-width:80%;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=index.js.c271de9d42ebbeef4dde.hot-update.js.map