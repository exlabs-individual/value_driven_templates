...
})(["min-width:50px;min-height:50px;max-width:50px;max-height:50px;text-align:center;line-height:50px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;&::after{}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.color.primary);
...
//# sourceMappingURL=how-to-contribute.js.9394baf24896148345f6.hot-update.js.map