...
})(["min-width:70px;min-height:70px;max-width:70px;max-height:70px;text-align:center;line-height:70px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;position:relative;&::after{content:'';display:block;width:6px;height:", ";background-color:", ";position:absolute;top:50px;left:50%;transform:translateX(-50%);}"], ({
  theme
}) => theme.color.white, ({
  theme
...
//# sourceMappingURL=how-to-contribute.js.4ac9e499c51ed7715a00.hot-update.js.map