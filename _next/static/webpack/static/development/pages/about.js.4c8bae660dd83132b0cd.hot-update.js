...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:calc(100% - 40px);margin-right:0;align-items:center;& .special-link{display:block;height:30px;line-height:30px;width:100%;text-align:center;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.4c8bae660dd83132b0cd.hot-update.js.map