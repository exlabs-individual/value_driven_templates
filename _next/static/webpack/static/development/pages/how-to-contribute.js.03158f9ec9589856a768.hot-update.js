...
})(["top:130px;min-width:70px;min-height:70px;max-width:70px;max-height:70px;text-align:center;line-height:70px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;position:relative;font-size:27px;", " @keyframes setColor{0%{background:#ebebeb;}100%{background:#044aaf;}}&::after{content:'';display:block;width:6px;height:", ";background-color:", ";position:absolute;top:70px;left:50%;transform:translateX(-50%);transition:height 3s ease;", "}"], ({
  theme
}) => theme.color.white, ({
  theme,
  active
...
//# sourceMappingURL=how-to-contribute.js.03158f9ec9589856a768.hot-update.js.map