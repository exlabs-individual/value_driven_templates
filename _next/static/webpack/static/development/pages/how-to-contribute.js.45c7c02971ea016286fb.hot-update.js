...
})(["min-width:70px;min-height:70px;max-width:100px;max-height:100px;text-align:center;line-height:100px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;position:relative;&::after{content:'';display:block;width:6px;height:", ";background-color:", ";position:absolute;top:50px;left:50%;transform:translateX(-50%);}"], ({
  theme
}) => theme.color.white, ({
  theme
...
//# sourceMappingURL=how-to-contribute.js.45c7c02971ea016286fb.hot-update.js.map