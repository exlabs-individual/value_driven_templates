...
const StyledFooter = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].footer.attrs(({
  ...
  theme
}) => theme.color.white, props => props.isMobile ? '15px 20px' : '20px 60px', props => props.isMobile ? 'column' : 'row', props => props.isMobile ? '15px' : '19px', props => props.isMobile ? '12px' : '15px');
...
//# sourceMappingURL=_app.js.8fd93baf37beb0843157.hot-update.js.map