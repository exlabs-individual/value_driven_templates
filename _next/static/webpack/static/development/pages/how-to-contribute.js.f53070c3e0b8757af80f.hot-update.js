...
const InformationSection = ({
  ...
  const handleScroll = react__WEBPACK_IMPORTED_MODULE_0___default.a.useCallback(() => {
    ...
    if (!isActive && window.pageYOffset - (containerHeight - 160) > ((_containerRef$current2 = containerRef.current) === null || _containerRef$current2 === void 0 ? void 0 : _containerRef$current2.getBoundingClientRect().top)) {
      setActive(true);
    }
...
//# sourceMappingURL=how-to-contribute.js.f53070c3e0b8757af80f.hot-update.js.map