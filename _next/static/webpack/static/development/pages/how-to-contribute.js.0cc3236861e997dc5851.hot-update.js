...
})(["flex:1;display:flex;flex-direction:column;justify-content:center;color:", ";@media (max-width:", "){flex:3;}@media (max-width:", "){width:100%;}"], ({
  theme
}) => theme.color.black, ({
  theme
...
})(["width:40%;@media (max-width:", "){margin-bottom:30px;width:70%;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=how-to-contribute.js.0cc3236861e997dc5851.hot-update.js.map