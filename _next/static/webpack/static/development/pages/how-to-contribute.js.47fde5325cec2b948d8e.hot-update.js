...
})(["min-width:50px;min-height:50px;max-width:50px;max-height:50px;text-align:center;line-height:50px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;position:relative;&::after{content:'';display:block;width:6px;height:", ";background-color:", ";position:absolute;top:50px;left:50%;transform:translateX(-50%);}"], ({
  theme
}) => theme.color.white, ({
  theme
...
//# sourceMappingURL=how-to-contribute.js.47fde5325cec2b948d8e.hot-update.js.map