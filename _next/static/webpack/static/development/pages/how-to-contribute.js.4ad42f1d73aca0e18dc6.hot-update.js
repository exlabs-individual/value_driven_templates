...
})(["font-size:30px;font-weight:300;margin:20px 0 70px;@media (max-width:", "){font-size:20px;}@media (max-width:", "){font-size:19px;text-align:center;margin:0 0 20px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=how-to-contribute.js.4ad42f1d73aca0e18dc6.hot-update.js.map