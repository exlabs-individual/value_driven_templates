...
})(["height:calc(100vh - 62px);color:", ";padding:10px ", ";padding-top:30px;display:flex;justify-content:space-between;@media (max-width:", "){height:auto;}@media (max-width:", "){height:100vh;}"], ({
  theme
}) => theme.color.black, ({
  theme
}) => theme.padding.small, ({
...
})(["display:flex;justify-content:space-between;margin-top:20px;width:100%;@media (max-width:", "){flex-direction:column;margin-top:0px;}@media (max-width:", "){}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
})(["display:flex;flex-direction:column;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:100%;margin-right:0;align-items:center;& .special-link{display:block;height:25px;line-height:25px;font-size:14px;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["height:50%;@media (max-width:", "){width:50%;height:auto;border:1px solid red;}@media (max-width:", "){min-width:80%;max-width:80%;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=index.js.d36ac4347ce10280282c.hot-update.js.map