...
})(["display:flex;flex-direction:column;position:relative;padding:20px 60px 40px;color:", ";background:linear-gradient(90deg,#044aaf,#022558);"], ({
  theme
}) => theme.color.white);
...
})(["& > .title{font-size:37px;margin:0;}& > .sub-title{margin:0;font-size:21px;font-weight:500;margin-top:10px;}& > .about-company{margin-top:50px;max-width:60%;font-size:19px;display:flex;align-items:flex-start;padding:0;&::before{content:'';width:70px;height:2px;background-color:", ";display:block;margin:7px 10px 0 0;}}"], ({
  theme
}) => theme.color.white);
...
})(["width:35%;position:absolute;bottom:150px;right:0;"]);

/***/ })

})
//# sourceMappingURL=how-to-contribute.js.5fecd5be6a9ebb4d5e8b.hot-update.js.map