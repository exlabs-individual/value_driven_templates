...
})(["border:1px solid red;width:100%;display:flex;justify-content:space-between;position:relative;&::after{content:'';display:block;width:6px;height:100%;background-color:", ";position:absolute;top:50px;left:50%;transform:translateX(-50%);}"], ({
  theme
}) => theme.color.primary);
...
const SectionNumber = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].h3.withConfig({
  displayName: "information-sectionstyles__SectionNumber",
  componentId: "xkgp05-5"
})(["min-width:50px;min-height:50px;max-width:50px;max-height:50px;text-align:center;line-height:50px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;position:relative;"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.color.primary);
...
//# sourceMappingURL=how-to-contribute.js.0ac134a9b82bae22f19c.hot-update.js.map