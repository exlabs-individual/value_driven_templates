...
})(["display:flex;justify-content:space-between;margin-top:20px;width:100%;@media (max-width:", "){flex-direction:column;margin-top:0px;}@media (max-width:", "){justify-content:center;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=about.js.b16d9213d1e7c9f7e26f.hot-update.js.map