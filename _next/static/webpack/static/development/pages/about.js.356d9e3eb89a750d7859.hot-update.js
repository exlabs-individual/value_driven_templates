...
})(["width:100%;height:calc(100vh - 62px);color:", ";padding:10px ", ";@media (max-width:", "){height:auto;margin-bottom:30px;}@media (max-width:", "){height:calc(100vh - 62px);}"], ({
  theme
}) => theme.color.black, ({
  theme
}) => theme.padding.small, ({
...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:calc(100% - 40px);margin-right:0;align-items:center;border:1px solid red;justify-content:flex-start;& .special-link{display:block;height:30px;line-height:30px;}}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
})(["font-size:65px;margin-top:130px;@media (max-width:", "){font-size:45px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
})(["width:60%;@media (max-width:", "){width:80%;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=about.js.356d9e3eb89a750d7859.hot-update.js.map