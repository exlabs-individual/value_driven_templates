...
})(["background:linear-gradient(90deg,#044aaf,#022558);color:", ";padding:", ";display:flex;flex-direction:", ";justify-content:space-between;& > .about-container{font-size:21px;}& > .copyright{font-size:13px;margin-top:5px;}"], ({
  theme
...
})(["display:flex;align-items:center;font-size:15px;& > .title{flex:1;font-weight:700;margin-right:5px;}& > .link{margin-left:5px;color:", ";text-decoration:none;display:flex;align-items:center;& > .logo-img{margin-right:5px;}}"], ({
  theme
}) => theme.color.white);
...
//# sourceMappingURL=_app.js.e56f8c02853145678e4a.hot-update.js.map