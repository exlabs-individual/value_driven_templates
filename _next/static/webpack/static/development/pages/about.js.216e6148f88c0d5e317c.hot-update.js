...
})(["width:55%;margin-left:20px;font-size:33px;font-weight:300;@media (max-width:", "){width:100%;margin-left:0;font-size:19px;border:1px solid red;}@media (max-width:", "){width:50%;font-size:19px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=about.js.216e6148f88c0d5e317c.hot-update.js.map