...
})(["min-width:50%;max-width:50%;@media (max-width:", "){min-width:70%;max-width:70%;}@media (max-width:", "){min-width:80%;max-width:80%;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.02cc8cac30eb4dec3780.hot-update.js.map