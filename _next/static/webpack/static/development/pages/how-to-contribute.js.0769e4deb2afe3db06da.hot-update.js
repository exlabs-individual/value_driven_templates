...
})(["width:100%;display:flex;justify-content:space-between;align-items:center;min-height:100vh;@media (max-width:", "){flex-direction:row-reverse;}"], ({
  theme
...
})(["width:40%;border:1px solid red;@media (max-width:", "){margin-bottom:30px;width:70%;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=how-to-contribute.js.0769e4deb2afe3db06da.hot-update.js.map