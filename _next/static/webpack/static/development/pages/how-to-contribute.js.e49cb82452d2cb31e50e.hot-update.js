...
})(["font-size:65px;margin-top:130px;@media (max-width:", "){font-size:50px;margin-top:10px;}@media (max-width:", "){font-size:28px;margin-top:10px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=how-to-contribute.js.e49cb82452d2cb31e50e.hot-update.js.map