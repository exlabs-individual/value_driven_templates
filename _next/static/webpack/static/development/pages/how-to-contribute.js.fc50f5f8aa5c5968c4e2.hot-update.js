...
})(["flex:1;display:flex;flex-direction:column;justify-content:center;color:", ";@media (max-width:", "){border:1px solid red;flex:3;}"], ({
  theme
}) => theme.color.black, ({
  theme
...
})(["flex:1;border:1px solid red;@media (max-width:", "){width:40%;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=how-to-contribute.js.fc50f5f8aa5c5968c4e2.hot-update.js.map