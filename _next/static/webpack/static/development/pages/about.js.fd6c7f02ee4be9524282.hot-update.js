...
})(["display:flex;align-items:center;justify-content:space-between;flex-direction:", ";width:100%;border:1px solid red;@media (max-width:", "){flex-direction:column;}"], props => props.textPosition === 'left' ? 'row-reverse' : 'row', ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["width:40%;@media (max-width:", "){width:100%;}@media (max-width:", "){width:50%;font-size:19px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
...
})(["width:55%;margin-left:20px;font-size:27px;font-weight:300;@media (max-width:", "){width:100%;margin-left:0;font-size:19px;border:1px solid red;}@media (max-width:", ") and (max-width:", "){width:50%;font-size:19px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
...
//# sourceMappingURL=about.js.fd6c7f02ee4be9524282.hot-update.js.map