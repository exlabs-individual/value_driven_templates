...
})(["min-width:50%;max-width:50%;@media (max-width:", "){min-width:40%;max-width:40%;}@media (max-width:", "){min-width:80%;max-width:80%;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=how-to-contribute.js.dcf556e9d26354e77fbc.hot-update.js.map