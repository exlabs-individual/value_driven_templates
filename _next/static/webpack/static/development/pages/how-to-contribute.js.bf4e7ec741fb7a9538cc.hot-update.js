...
})(["font-size:49px;margin-bottom:20px;@media (max-width:", "){font-size:34px;}@media (max-width:", "){font-size:21px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=how-to-contribute.js.bf4e7ec741fb7a9538cc.hot-update.js.map