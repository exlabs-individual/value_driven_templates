...
})(["background-color:", ";padding:10px ", ";animation:moveUp 0.3s ease-in-out;display:flex;justify-content:space-between;", " @keyframes moveUp{from{transform:translateY(-5rem);}to{transform:translateY(0rem);}}@keyframes moveDown{from{transform:translateY(-5rem);}to{transform:translateY(0rem);}}"], ({
  theme,
  themeType
...
//# sourceMappingURL=_app.js.ee3dc8c50e2e38254e38.hot-update.js.map