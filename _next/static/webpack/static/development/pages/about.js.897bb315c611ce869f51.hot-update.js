...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:calc(100% - 40px);margin-right:0;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
})(["font-size:65px;margin-top:130px;@media (max-width:", "){font-size:45px;text-align:center;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
})(["font-size:30px;font-weight:300;margin-bottom:70px;"]);
...
})(["width:60%;@media (max-width:", "){font-size:45px;text-align:center;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=about.js.897bb315c611ce869f51.hot-update.js.map