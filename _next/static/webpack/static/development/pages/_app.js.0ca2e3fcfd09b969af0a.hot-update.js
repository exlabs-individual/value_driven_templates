...
const StyledFooter = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].footer.attrs(({
  ...
  theme
}) => theme.color.white, props => props.isMobile ? '15px 20px' : '20px 60px', props => props.isMobile ? 'column' : 'row', props => props.isMobile ? '14px' : '19px', props => props.isMobile ? '13px' : '15px');
...
//# sourceMappingURL=_app.js.0ca2e3fcfd09b969af0a.hot-update.js.map