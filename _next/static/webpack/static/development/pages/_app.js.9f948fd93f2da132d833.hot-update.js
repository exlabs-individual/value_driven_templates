...
})(["background-color:", ";padding:10px ", ";animation:moveUp 0.3s ease-in-out;display:flex;", " @keyframes moveUp{from{transform:translateY(-5rem);}to{transform:translateY(0rem);}}@keyframes moveDown{from{transform:translateY(-5rem);}to{transform:translateY(0rem);}}"], ({
  theme,
  themeType
...
//# sourceMappingURL=_app.js.9f948fd93f2da132d833.hot-update.js.map