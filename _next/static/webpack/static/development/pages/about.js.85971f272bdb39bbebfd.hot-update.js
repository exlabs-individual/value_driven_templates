...
})(["width:100%;height:calc(100vh - 62px);color:", ";padding:10px ", ";@media (max-width:", "){height:auto;margin-bottom:30px;}@media (max-width:", "){height:calc(100vh - 62px);margin-bottom:30px;}"], ({
  theme
}) => theme.color.black, ({
  theme
}) => theme.padding.small, ({
...
//# sourceMappingURL=about.js.85971f272bdb39bbebfd.hot-update.js.map