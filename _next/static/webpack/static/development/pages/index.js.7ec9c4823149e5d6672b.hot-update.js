...
})(["padding-left:", ";width:40%;color:", ";& > .title{font-size:49px;margin:0;}& > .sub-title{margin:0;margin-top:5px;font-weight:500;font-size:21px;}& > .additional-info{display:block;margin:40px 0 50px;&::before{content:'';display:inline-block;margin-right:10px;height:2px;width:30px;background-color:", ";margin-bottom:10px;}}& > .special-link{display:inline-block;}"], ({
  theme
}) => theme.padding.big, ({
  theme
}) => theme.color.black, ({
...
//# sourceMappingURL=index.js.7ec9c4823149e5d6672b.hot-update.js.map