...
})(["width:40%;@media (max-width:", "){width:100%;}@media (min-width:", ") and (max-width:", "){width:50%;font-size:19px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
...
})(["width:55%;margin-left:20px;font-size:27px;font-weight:300;@media (max-width:", "){width:100%;margin-left:0;font-size:19px;}@media (min-width:", ") and (max-width:", "){width:70%;font-size:19px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
...
//# sourceMappingURL=about.js.4d0cae5977600e867bc6.hot-update.js.map