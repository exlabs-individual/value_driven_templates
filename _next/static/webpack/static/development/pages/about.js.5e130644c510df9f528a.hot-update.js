...
})(["display:flex;flex-direction:column;width:50%;margin-right:30px;& .special-link{display:inline-block;height:30px;line-height:30px;}@media (max-width:", "){width:calc(100% - 40px);margin-right:0;align-items:center;& .special-link{display:block;height:30px;line-height:30px;width:100%;}}"], ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
//# sourceMappingURL=about.js.5e130644c510df9f528a.hot-update.js.map