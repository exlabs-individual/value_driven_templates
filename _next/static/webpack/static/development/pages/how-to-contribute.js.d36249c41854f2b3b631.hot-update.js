...
})(["min-width:50px;min-height:50px;max-width:50px;max-height:50px;text-align:center;line-height:50px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;position:relative;&::after{content:'';display:block;width:6px;height:100vh;background-color:", ";position:absolute;top:52px;left:50%;transform:translateX(-50%);}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.color.primary, ({
...
//# sourceMappingURL=how-to-contribute.js.d36249c41854f2b3b631.hot-update.js.map