...
})(["flex:1;display:flex;flex-direction:column;justify-content:center;color:", ";@media (max-width:", "){flex:3;}@media (max-width:", "){align-items:center;}"], ({
  theme
}) => theme.color.black, ({
  theme
...
})(["font-size:49px;margin-bottom:20px;@media (max-width:", "){font-size:34px;}@media (max-width:", "){font-size:321px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["font-size:21px;@media (max-width:", "){font-size:18px;}@media (max-width:", "){font-size:14px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet, ({
  theme
}) => theme.deviceBreakpoint.mobile);
...
})(["width:40%;@media (max-width:", "){margin-bottom:30px;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=how-to-contribute.js.ed8d94905940ecac59c7.hot-update.js.map