...
})(["flex:1;display:flex;flex-direction:column;justify-content:center;color:", ";@media (max-width:", "){flex:3;border:1px solid red;}"], ({
  theme
}) => theme.color.black, ({
  theme
...
})(["flex:1;@media (max-width:", "){width:40%;border:1px solid red;}"], ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=how-to-contribute.js.191f858540b4ca12eaf2.hot-update.js.map