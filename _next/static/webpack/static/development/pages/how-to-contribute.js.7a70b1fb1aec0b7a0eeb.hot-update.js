...
const InformationSection = ({
  ...
  const handleScroll = react__WEBPACK_IMPORTED_MODULE_0___default.a.useCallback(() => {
    ...
    if (!isActive && window.pageYOffset > ((_containerRef$current2 = containerRef.current) === null || _containerRef$current2 === void 0 ? void 0 : _containerRef$current2.getBoundingClientRect().top) + 200) {
      setActive(true);
    }
...
//# sourceMappingURL=how-to-contribute.js.7a70b1fb1aec0b7a0eeb.hot-update.js.map