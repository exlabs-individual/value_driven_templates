...
})(["display:flex;justify-content:space-between;margin-top:20px;width:100%;@media (max-width:", "){flex-direction:column;margin-top:0px;}@media (max-width:", "){flex-direction:column;margin-top:0px;}"], ({
  theme
}) => theme.deviceBreakpoint.mobile, ({
  theme
}) => theme.deviceBreakpoint.tablet);
...
//# sourceMappingURL=about.js.5bc9877d6eb86a5f2130.hot-update.js.map