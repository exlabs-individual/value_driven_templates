...
})(["min-width:50px;min-height:50px;max-width:50px;max-height:50px;text-align:center;line-height:50px;color:", ";background-color:", ";border-radius:50%;margin:0 20px;&::after{content:'';display:block;width:10px;height:100%;background-color:", ";}"], ({
  theme
}) => theme.color.white, ({
  theme
}) => theme.color.primary, ({
...
//# sourceMappingURL=how-to-contribute.js.0ea026ff3f62b6fb928d.hot-update.js.map